    ...
    /***/ function (module, exports) {
        ...
        var User = React.createClass({
            ...
            render: function render() {
                return React.createElement("div", {className: "user"}, React.createElement("h2", null, this.props.firstName.concat(" ", this.props.lastName)));
            }
        });
        ...
        var UserList = React.createClass({
            ...
            render: function render() {
                var UserNodes = this.props.data.map(function (user, index) {
                    return React.createElement(User, {firstName: user.firstName, lastName: user.lastName, key: index});
                });
                return React.createElement("div", {className: "userList"}, UserNodes);
            }
        });
        ...
        var UserBox = React.createClass({
            ...
            render: function render() {
                this.loadUsersFromServer();
                return React.createElement("div", {className: "UserBox"}, React.createElement("h1", null, "User"), React.createElement(UserList, {data: this.state.data}));
            }
        });
